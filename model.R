...
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/all.png' ) , plot = last_plot(), device = "png")
...
ggplot(melt,                            
  ...
  geom_line()
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/sex.png' ) , plot = last_plot(), device = "png")
...
ggplot(melt,                            
  ...
  geom_line()
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/current_age.png' ) , plot = last_plot(), device = "png")
...
ggplot(melt,                            
  ...
  scale_colour_gradient(low = "red", high = "blue")+
  geom_line()
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/weight.png' ) , plot = last_plot(), device = "png")
...
ggplot(melt,                            
  ...
  geom_line()
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/genotype.png' ) , plot = last_plot(), device = "png")
...
ggplot(melt,                            
  ...
  geom_line()
ggsave(paste0('/Users/ali/Desktop/may23/risk/code/figures/risk.png' ) , plot = last_plot(), device = "png")
...
pathnames='/Users/ali/Desktop/may23/risk/code/anatomyInfo_whiston_new.csv'
